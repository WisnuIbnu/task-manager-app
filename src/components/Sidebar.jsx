        ...
        {menuItems.map(({ text, path, icon }) => (
          <li key={text}>
            ...
            >
              ...
              <span
                className={`ml-3 ${isMobile ? "block" : "hidden lg:block"} ${LINK_CLASSES}`}
              >
                {text}
              </span>
            </NavLink>
            ...
            <div className={TIP_CARD.container}>
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className={TIP_CARD.text}>Visit to Our Developer</p>
                  <a href="https://wisnuibnu-dev.vercel.app/" target='_blank' className=' block mt-2 text-sm text-purple-500 hover:underline'>WisnuIbnu Portofolio</a>
                </div>
              </div>
            </div>
          </div>
